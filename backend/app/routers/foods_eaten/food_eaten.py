from backend.app.routers.foods_eaten import foods_eaten_functions as fe_funcs
from fastapi import APIRouter, HTTPException, status
from backend.schemas import FoodEaten as FoodEaten_schema
from fastapi_sqlalchemy import db
from backend.models import User, Food, FoodEaten, ProcessedData
